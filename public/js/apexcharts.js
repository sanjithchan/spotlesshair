          ...
          return r(t, [{
              ...
              value: function(t, e) {
                  ...
                  return e && !s && (s = e.config.series), a && s.length !== t.yaxis.length && s.length && (t.yaxis = s.map((function(e, a) {
                      if (e.name || (s[a].name = "count-".concat(a + 1)), t.yaxis[a]) return t.yaxis[a].seriesName = s[a].name, t.yaxis[a];
          ...
          return r(t, [{
              ...
              value: function(t, e, i, a) {
                  ...
                  if ((o.globals.markers.size[e] > 0 || r || d) && (h = c.group({
                          class: r || d ? "" : "apexcharts-count-markers"
          ...
          return r(t, [{
              ...
              value: function(t, e, i) {
                  var a = this.w,
                      ...
                      l = i.elParent,
                      h = s.group({
                          class: "apexcharts-series-markers apexcharts-count-".concat(a.config.chart.type)
                      });
          ...
          return r(t, [{
              ...
              value: function(t) {
                  ...
                  for (var n = function() {
                      ...
                      s.seriesZ.push(this.threeDSeries), void 0 !== t[l].name ? s.seriesNames.push(t[l].name) : s.seriesNames.push("count-" +''), void 0 !== t[l].color ? s.seriesColors.push(t[l].color) : s.seriesColors.push(void 0)
                  }
                  return this.w
              }
          }, {
              ...
              value: function(t) {
                  ...
                  for (var a = 0; a < e.series.length; a++) void 0 === e.seriesNames[a] && e.seriesNames.push("count-" + (a + 1));
                  return this.w
              }
          }, {
          ...
          return r(t, [{
              ...
              value: function(t) {
                  ...
                  h.push(l.config.chart.toolbar.export.csv.headerCategory), "boxPlot" === l.config.chart.type ? (h.push("minimum"), h.push("q1"), h.push("median"), h.push("q3"), h.push("maximum")) : "candlestick" === l.config.chart.type ? (h.push("open"), h.push("high"), h.push("low"), h.push("close")) : "rangeBar" === l.config.chart.type ? (h.push("minimum"), h.push("maximum")) : i.map((function(t, e) {
                      var i = t.name ? t.name : "count-".concat(e);
                      l.globals.axisCharts && h.push(i.split(r).join("") ? i.split(r).join("") : "count-".concat(e))
              ...
              value: function(t, e, i, a, s, r) {
                  ...
                  for (var w = function(s) {
                          ...
                          var y = n.axesUtils.getLabel(a, d.globals.timescaleLabels, l, s, h, g, t),
                              w = 28;
                          d.globals.rotateXLabels && t && (w = 22), d.config.xaxis.title.text && "top" === d.config.xaxis.position && (w += parseInt(d.config.xaxis.title.style.fontSize) + 2), t || (w = w + parseInt(g) + (d.globals.xAxisLabelsHeight - d.globals.xAxisGroupLabelsHeight) + (d.globals.rotateXLabels ? 10 : 0)), y = void 0 !== d.config.xaxis.tickAmount && "dataPoints" !== d.config.xaxis.tickAmount && "datetime" !== d.config.xaxis.type ? n.axesUtils.checkLabelBasedOnTickamount(s, y, v) : n.axesUtils.checkForOverflowingLabels(s, y, v, h, c);
