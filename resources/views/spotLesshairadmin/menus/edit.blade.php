        ...
        <div class="wrap-body my-2">
            <div class="card full-card mb-3 border">
                <div class="card-body px-4">
                    <form method="POST" action="{{ url(ADMIN.'/menu/update/'.$menudata->menu_uuid) }}" class="row" id="updatemenu" enctype="multipart/form-data">
                        @csrf
                                        ...
                                        <div class="row">
                                            <div class="col-12 col-lg-6 mb-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="page_name" id="page_name" class="form-control convertMenu" value="{{$menudata->page_name}}" placeholder="Enter Page name"  disabled>
                                                </div>
                                            </div>
											<div class="col-12 col-lg-6 mb-3">
                                                <div class="form-group">
                                                    <label for="title">Menu Name <span class="red">*</span></label>
                                                    <input type="text" name="menu_name" id="menu_name" class="form-control" value="{{$menudata->menu_name}}"  placeholder="Enter menu name"  autofocus>
                                                </div>
                                            </div>
											<div class="col-12 col-lg-6 mb-3">
                                                <div class="form-group">
                                                    <label for="title">Page Link <span class="red">*</span></label>
                                                    <input type="text" name="page_link" id="page_link" class="form-control convertMenu" value="{{$menudata->page_link}}" placeholder="Enter page link"  disabled>
                                                </div>
                                            </div>
											<div class="col-12 col-lg-6 mb-3">
											<div class="form-group">
												...
												<select name="parent_id" class="form-control" autofocus>
													...
													@if(!empty($parentMenu))
														...
														<option value="{{ $menu->id }}" @if($menudata->parent_id == $menu->id) selected @endif>{{ $menu->page_name }}</option>
											...
											<div class="col-12 col-lg-6 mb-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="title" class="form-control" placeholder="Enter Title" value="{{$menudata->title}}"  autofocus>
                                                </div>
                                            </div>
											<div class="col-12 col-lg-6 mb-3">
                                                <div class="form-group">
                                                    <label for="title">Meta Description <span class="red">*</span></label>
                                                    <input type="text" name="meta_description" class="form-control" value="{{$menudata->meta_description}}" placeholder="Enter meta description"  autofocus>
                                                </div>
                                            </div>
											<div class="col-12 col-lg-6 mb-3">
                                                <div class="form-group">
                                                    <label for="title">Meta Keyword <span class="red">*</span></label>
                                                    <textarea name="meta_keywords" class="form-control"  >{{$menudata->meta_keywords}}</textarea>
                                                </div>
                                            </div>
											...
											<div class="col-12 col-lg-3 mb-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="sort_order" class="form-control" value="{{$menudata->sort_order}}" placeholder="Enter sortorder"  autofocus>
                                                </div>
                                            </div>
											<div class="col-12 col-lg-3 mb-3">
											<div class="form-group">
												...
												<select name="status" class="form-control" autofocus>													
													<option value="1" @if($menudata->status =='1') selected @endif>Active</option>
													<option value="0" @if($menudata->status =='0') selected @endif>Inactive</option>
				...
				rules: {
					menu_name: {
						 ...
						 remote: {
							...
							data: {'_token': $('input[name=_token]').val(),"menu_id":"{{$menudata->id}}"},
							type: "post"
						},
						maxlength: 45,
					},					
